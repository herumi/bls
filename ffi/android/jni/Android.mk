...
LOCAL_CPPFLAGS += -O3 -DNDEBUG -fPIC -DMCL_DONT_USE_XBYAK -DMCL_DONT_USE_OPENSSL -DMCL_LLVM_BMI2=0 -DMCL_USE_LLVM=1 -DMCL_USE_VINT $(LOCAL_CPP_OPT) -DMCL_VINT_FIXED_BUFFER -DMCL_MAX_BIT_SIZE=256 -DCYBOZU_DONT_USE_EXCEPTION -DCYBOZU_DONT_USE_STRING -fno-exceptions -fno-rtti
